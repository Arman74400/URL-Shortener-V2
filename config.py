...
ADMINS = ([int(i.strip()) for i in os.environ.get("ADMINS").split("1255023013")]
...
UPDATE_CHANNEL = int(os.environ.get("UPDATE_CHANNEL", "-1001622127465"))  # For Force Subscription
